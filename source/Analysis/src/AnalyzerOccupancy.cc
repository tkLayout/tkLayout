 ...
 AnalyzerUnit("AnalyzerOccupancy", detector)
{
  ...
  m_photonsMapBOnMatOn   = nullptr;
  m_chargedMapBOnMatOn   = nullptr;
...
bool AnalyzerOccupancy::init(int nTracks)
{
  ...
  if (chargedMapOK) m_chargedMapBOnMatOn  = new IrradiationMap(directory + "/" + SimParms::getInstance().chargedMapFile());
  if (photonsMapOK) m_photonsMapBOnMatOn  = new IrradiationMap(directory + "/" + SimParms::getInstance().photonsMapFile());
