 ...
 */
Module &ModuleCap::getModule() { return *m_module; }

/**
 * Get the module surface.
 * @return The module surface that is relevant for tracking
 */
double ModuleCap::getSurface() const { return m_module->area(); }

/**
 * Get the module surface.
 * @return The module surface that is relevant for tracking
 */
double ModuleCap::getLength() const { return m_module->length(); }
...
void ModuleCap::print() {
  ...
  std::cout << "Associated module is of type " << m_module->moduleType() << "."
            << std::endl;
}
} // namespace insur
