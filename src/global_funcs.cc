...
template <>
std::string StringConverter<_NOT_STRING_ENUM>::str2any<std::string>(
    const std::string &from) {
  return from;
};

template <>
bool StringConverter<_NOT_STRING_ENUM>::str2any<bool>(const std::string &from) {
  static std::map<std::string, bool> boolstr = {
