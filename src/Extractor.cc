    ...
    if ((iter->getZOffset() + iter->getZLength()) > 0) {
      if (iter->getLocalMasses().size()) {
        ...
        // ENDCAPS services
          ...
          // the Timing Layer is put in the tracker, and hence tracker and
          // timing services are grouped togetehr. TO DO : Place timing layer in
          // an independant container." << std::endl; }
        }
