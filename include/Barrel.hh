...
class Barrel : public PropertyObject,
               public Buildable,
...
public:
  Barrel()
      : innerRadius("innerRadius", parsedAndChecked()),
        ...
        layerNode("Layer", parsedOnly()), supportNode("Support", parsedOnly()),
