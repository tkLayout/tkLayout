 ...
 * @brief This header file lists XML text constants that are combined and
 * concatenated with various parameter values during translation of a geometry
 * to CMSSW XML.
 */
 ...
 * Numeric constants
 */
static const double xml_z_pixfwd =
    291.0; // VERY IMPORTANT : xml_z_pixfwd defines the offset of the Pixel
           // Forward container volume.
// It should be equal to ZPixelForward defined statically in pixfwd.xml.
// Otherwise, anything contained by Pixel Forward will have wrong Z in XMLs !!
static const double xml_epsilon =
    0.01; // Added to virtual geometrical mother volume to avoid extrusion of
          // what it contains.
...
static const double xml_innerTrackerEndcapsMinZ =
    227.; // from PIXEL 4_0_2_1 onwards  // PIXEL 1_1_1 : 300.
static const double xml_innerTiltedTrackerEndcapsMinZ = 415.; // 390. for IT_500
static const std::string xml_trackerOutermostRadius =
    "122.15*cm"; // Outermost tracker volume boundary
...
static const std::string xml_definition =
...
static const std::string xml_const_section =
    ...
    "name=\"BackPlaneDz\" value=\"0.015*mm\"/>\n<Constant "
    "name=\"TrackerOutermostRadius\" value=\"" +
    xml_trackerOutermostRadius + "\"/>\n</ConstantsSection>\n";
static const std::string xml_new_const_section =
    "<ConstantsSection label=\"newtracker.xml\" eval=\"true\">\n<Constant "
    "name=\"newDummyBackPlaneDz\" value=\"0.015*mm\"/>\n</ConstantsSection>\n";
static const std::string xml_recomat_parameters =
    "<Parameter name=\"TrackerRadLength\" value=\"0.01\"/>\n<Parameter "
    "name=\"TrackerXi\" value=\"0.0001";
...
static const std::string xml_material_section_open =
    "<MaterialSection label=\"";
static const std::string xml_material_section_close = "</MaterialSection>\n";
static const std::string xml_rotation_section_open =
    "<RotationSection label=\"";
static const std::string xml_rotation_section_close = "</RotationSection>\n";
static const std::string xml_logical_part_section_open =
    "<LogicalPartSection label=\"";
static const std::string xml_logical_part_section_close =
    "</LogicalPartSection>\n";
...
static const std::string xml_algorithm_vector_open =
...
static const std::string xml_elementary_material_open =
    "<ElementaryMaterial name=\"";
static const std::string xml_elementary_material_first_inter = "\" symbol=\"";
static const std::string xml_elementary_material_second_inter =
    "\" atomicNumber=\"";
static const std::string xml_elementary_material_third_inter =
    "\" atomicWeight=\"";
static const std::string xml_elementary_material_fourth_inter =
    "*g/mole\" density=\"";
static const std::string xml_elementary_material_close = "*g/cm3\"/>\n";
static const std::string xml_composite_material_open =
    "<CompositeMaterial name=\"";
static const std::string xml_composite_material_first_inter = "\" density=\"";
static const std::string xml_composite_material_second_inter =
    "*g/cm3\" method=\"";
static const std::string xml_composite_material_close =
    "</CompositeMaterial>\n";
static const std::string xml_material_fraction_open =
...
static const std::string xml_logical_part_first_inter =
...
static const std::string xml_tubs_close =
    "*mm\" startPhi=\"0*deg\" deltaPhi=\"360*deg\"/>\n";
...
static const std::string xml_cone_close =
    "*mm\" startPhi=\"0*deg\" deltaPhi=\"360*deg\"/>\n";
static const std::string xml_polycone_open = "<Polycone name=\"";
static const std::string xml_polycone_inter =
...
static const std::string xml_spec_par_parameter_evaluation =
    "\" eval=\"true"; // numerical parameters need to be evaluated
...
static const std::string xml_mechanicalCategoriesHeader =
    "Phase 2 Tracker materials: 4 mechanical categories.";
...
static const std::string xml_newtopologyfile =
    "newTrackerStructureTopology.xml";
...
static const std::string xml_mechanicalCategoriesRLfile =
    "mechanicalCategoriesRL.txt";
static const std::string xml_mechanicalCategoriesILfile =
    "mechanicalCategoriesIL.txt";
...
static const std::string xml_OT_insert_marker =
...
static const std::string xml_base_inner =
    "INNER"; // This is for distinguishing inner/outer sensor!
static const std::string xml_base_outer = "OUTER";
static const std::string xml_base_lower =
    "Lower"; // This is for distinguishing inner/outer sensor!
...
static const std::string xml_pixfwd_plus =
    "PixelForward[1]"; // CUIDADO was: "PixelForwardZPlus";
static const std::string xml_pixfwd_minus =
    "PixelForward[2]"; // CUIDADO was: "PixelForwardZMinus";
...
static const std::string xml_subdet_straight_or_tilted_rod =
    "PixelBarrelLadder";
...
static const std::string xml_OT_places_unflipped_mod_in_rod =
    "OUTERTRACKERRODTOMODULE";
static const std::string xml_OT_places_flipped_mod_in_rod =
    "OUTERTRACKERRODTOFLIPPEDMODULE";
static const std::string xml_PX_places_unflipped_mod_in_rod =
    "INNERTRACKERRODTOMODULE";
static const std::string xml_PX_places_flipped_mod_in_rod =
    "INNERTRACKERRODTOFLIPPEDMODULE";
...
static const std::string xml_OT_topo_layer_name =
    "OuterTrackerPixelBarrelLayer";
...
static const std::string xml_OT_topo_straight_rod_name =
    "OuterTrackerPixelBarrelLadder";
...
static const std::string xml_OT_topo_tilted_ring_name =
    "OuterTrackerPixelBarrelRing";
static const std::string xml_PX_topo_tilted_ring_name =
    "InnerTrackerBarrelRing";
...
static const std::string xml_PX_topo_emodule_value =
    "PixelPhase2PixelEndcapStack";
...
struct XmlTags {
  XmlTags(bool isPixelTracker)
      : nspace(!isPixelTracker ? xml_fileident : xml_PX_fileident),
        ...
        trackersensfile(!isPixelTracker ? xml_trackersensfile
                                        : xml_PX_trackersensfile),
        recomatfile(
            xml_recomatfile), // For users convinience, reco material info is
                              // stored in only one file for both OT and PX.
        insert_marker(!isPixelTracker ? xml_OT_insert_marker
                                      : xml_PX_insert_marker),

        topo_barrel_name(!isPixelTracker ? xml_OT_topo_barrel_name
                                         : xml_PX_topo_barrel_name),
        topo_barrel_value(!isPixelTracker ? xml_OT_topo_barrel_value
                                          : xml_PX_topo_barrel_value),
        topo_layer_name(!isPixelTracker ? xml_OT_topo_layer_name
                                        : xml_PX_topo_layer_name),
        topo_layer_value(!isPixelTracker ? xml_OT_topo_layer_value
                                         : xml_PX_topo_layer_value),
        topo_straight_rod_name(!isPixelTracker ? xml_OT_topo_straight_rod_name
                                               : xml_PX_topo_straight_rod_name),
        topo_straight_rod_value(!isPixelTracker
                                    ? xml_OT_topo_straight_rod_value
                                    : xml_PX_topo_straight_rod_value),
        topo_tilted_ring_name(!isPixelTracker ? xml_OT_topo_tilted_ring_name
                                              : xml_PX_topo_tilted_ring_name),
        topo_tilted_ring_value(!isPixelTracker ? xml_OT_topo_tilted_ring_value
                                               : xml_PX_topo_tilted_ring_value),
        topo_bmodule_name(!isPixelTracker ? xml_OT_topo_bmodule_name
                                          : xml_PX_topo_bmodule_name),
        topo_bmodule_value(!isPixelTracker ? xml_OT_topo_bmodule_value
                                           : xml_PX_topo_bmodule_value),
        topo_endcaps_name(!isPixelTracker ? xml_OT_topo_endcaps_name
                                          : xml_PX_topo_endcaps_name),
        topo_endcaps_value(!isPixelTracker ? xml_OT_topo_endcaps_value
                                           : xml_PX_topo_endcaps_value),
        topo_disc_name(!isPixelTracker ? xml_OT_topo_disc_name
                                       : xml_PX_topo_disc_name),
        topo_disc_value(!isPixelTracker ? xml_OT_topo_disc_value
                                        : xml_PX_topo_disc_value),
        topo_ring_name(!isPixelTracker ? xml_OT_topo_ring_name
                                       : xml_PX_topo_ring_name),
        topo_ring_value(!isPixelTracker ? xml_OT_topo_ring_value
                                        : xml_PX_topo_ring_value),
        topo_emodule_name(!isPixelTracker ? xml_OT_topo_emodule_name
                                          : xml_PX_topo_emodule_name),
        topo_emodule_value(!isPixelTracker ? xml_OT_topo_emodule_value
                                           : xml_PX_topo_emodule_value),

        reco_layer_name(xml_reco + (!isPixelTracker ? xml_OT_reco_layer_name
                                                    : xml_PX_reco_layer_name)),
        reco_disc_name(xml_reco + (!isPixelTracker ? xml_OT_reco_disc_name
                                                   : xml_PX_reco_disc_name)){};
