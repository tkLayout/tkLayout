...
namespace insur {
  ...
  public:
    ...
    std::map<std::string, std::map<std::string, SummaryTable> > getWeightBySubdetector() const { return weightBySubdetector_; }
  ...
  protected:
    ...
    std::map<std::string, std::map<std::string, SummaryTable> > weightBySubdetector_;
    ...
    std::map<std::string, std::map<std::string, SummaryTable> > computeWeightBySubdetector(MaterialBudget& mb);
