...
/**
 * @file InactiveRing.h
 * @brief This is the derived class header file for a single ring-shaped
 * inactive element
 */
...
/**
 * @class InactiveRing
 * @brief The only thing that this class adds to its parent is a check that it
 * is a ring rather than a tube.
 */
