...
private:
  ...
  const double autoLayerMarginUpper =
      insur::geom_support_margin_bottom; // 1.; // margins for the auto barrel
                                         // support
  const double autoLayerMarginLower =
      insur::geom_support_margin_top +
      2. * insur::geom_inactive_volume_width; // 2.; // +
                                              // insur::geom_inactive_volume_width;
                                              // //upper is upper for the support
                                              // (is lower for the layer) and
                                              // viceversa
  ...
  void buildInactiveElementPair(Direction direction, double zStart,
                                double rStart, double length);
