...
public:
  MaterialSection(double newMinZ, double newMinR, double newMaxZ,
...
public:
  MaterialStation(double minZ, double minR, double maxZ, double maxR,
                  Direction bearing, MaterialSection *nextSection);
  MaterialStation(double minZ, double minR, double maxZ, double maxR,
                  Direction bearing);
