...
class PtErrorAdapter {
  ...
  static const double
      ptFitParamsLow[]; // 0.22 GeV to 1 GeV  Chi^2 / dof = 22.0408/16 = 1.37755
  static const double
      ptFitParamsMid[]; // 1 GeV to 4 GeV     Chi^2 / dof = 84.2299/71 = 1.18634
  static const double ptFitParamsHigh[]; // 4 GeV to 10 GeV    Chi^2 / dof =
                                         // 102.736/135 = 0.76101
...
public:
  ...
  double getTriggerFrequencyTruePerEventBetween(double myLowCut,
                                                double myHighCut);
