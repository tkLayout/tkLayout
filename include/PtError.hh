...
private:
  // Global parameters
  static double
      IP_length;   // in mm // TODO: setter and getter for this parameter
...
public:
  ...
  void setZCorrelation(ZCorrelation newZCorrelation) {
    zCorrelation = newZCorrelation;
  }
  ...
  // Error computation
  double
  computeErrorBE(double p); // CUIDADO only for testing, called by computeError
                            // after previously setting the correct parameters
